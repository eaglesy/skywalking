...
public class URLInstrumentation2 extends ClassEnhancePluginDefine {
    private static String CLASS_NAME = "a.Main";
        ...
        return new StaticMethodsInterceptPoint[] {
            new StaticMethodsInterceptPoint() {
                ...
                @Override public String getMethodsInterceptor() {
                    return "org.apache.skywalking.apm.plugin.activemq.Interceptor2";
                }
